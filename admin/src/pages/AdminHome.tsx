      ...
      {data && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <section className="sol-card p-5">
            ...
            <Link to="/refunds" className="sol-btn-secondary sol-btn-sm mt-3 inline-flex">
              Xử lý queue ›
            </Link>
          </section>
          ...
          <section className="sol-card p-5">
            ...
            <Link to="/cohorts" className="sol-btn-secondary sol-btn-sm mt-3 inline-flex">
              Đội Sol theo tháng ›
            </Link>
          </section>
          ...
          <section className="lg:col-span-3 sol-card p-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
              <Link to="/users" className="sol-btn-secondary text-center">
                👥 Tất cả user
              </Link>
              <Link to="/voice" className="sol-btn-secondary text-center">
                🎙️ Voice library
              </Link>
              <Link to="/analytics" className="sol-btn-secondary text-center">
                📈 Funnel + revenue
              </Link>
              <Link to="/wiki" className="sol-btn-secondary text-center">
                📰 WordPress wiki
              </Link>
            </div>
          </section>

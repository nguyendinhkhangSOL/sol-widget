#!/usr/bin/env node
/**
 * Sol — Bulk set Featured Image cho 3 bài SEO Pass 26-5
 *
 * Đọc OG images từ wiki-skeletons/seo-pass-26-5/og-images/<slug>.png,
 * upload lên WP Media Library, set featured_media cho từng post.
 *
 * Usage:
 *   node set-featured-seo-pass-26-5.js
 *
 * Tiền điều kiện:
 *   1. Đã chạy gen-og-seo-pass-26-5.js (3 PNG đã tồn tại)
...
const OG_DIR = path.resolve(__dirname, '..', '..', 'wiki-skeletons', 'seo-pass-26-5', 'og-images');

const SLUGS = [
  'lo-trinh-cai-thuoc-la-khoa-hoc-7-ngay',
  'tai-sao-cai-thuoc-la-lai-bi-ho-co-dom',
  'tac-hai-thuoc-la-thu-dong-doi-voi-tre-nho',
];
...
async function processSlug(slug) {
  ...
  if (!post) {
    return { slug, status: 'fail', err: 'Post không tìm thấy' };
  }
...
async function main() {
  console.log('========================================');
  console.log('  SEO PASS 26-5 — Set Featured Image (3 bài)');

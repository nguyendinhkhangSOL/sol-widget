...
const SEO_MAPPING = [
  ...
  [
    ...
    'Bảng giá Sol Đi Cùng — 3 lộ trình Nhẹ 35d / Vừa 52d / Nặng 65d. 4 cách trả: Trả Thử 49k / Tuần / Một Lần / Sau Khi Thành Công. Hoàn tiền không hỏi.',
    'giá cai thuốc lá',
  ],
  [
    'Câu chuyện Khang',
    ...
    'Câu chuyện founder Sol Đi Cùng. Đã hút Vinataba 30 năm từ 15 tuổi ở quê. Thử bỏ 4 lần thất bại. Lần thứ 5 thành công 22-12-2020 — đến nay 5 năm Tự do.',
    'khang sol',
  ],
  [
    'Sol là gì',
    'sol-la-gi',
    'Sol Đi Cùng Là Gì — Phương Pháp Cai Thuốc Cho Việt 45+',
  ...
  [
    ...
    'Pilot Q2/2026 — 30 anh em đầu nhận MIỄN PHÍ Sol Đi Cùng (giá 149-349k). Đổi lại: check-in 30 giây/ngày + phỏng vấn cuối lộ trình. Đăng ký ngay.',
    'pilot cai thuốc',
  ],
  [
    '5 phương pháp',
    ...
    'So sánh chi tiết Cold Turkey, NRT, Champix, Allen Carr, app tracker. Mỗi cái mạnh ở đâu, yếu ở đâu. Sol Đi Cùng = Hybrid 5 — viết tiếng Việt cho Việt 45+.',
    'phương pháp cai thuốc lá',
  ],
  [
    'Hub Bỏ thuốc lá',
    'bo-thuoc-la',
    'Cai Thuốc Lá — Sol Đi Cùng Cho Anh Em Việt 45+',

 ...
 *   sol.vn         → Brand CTA "Trải nghiệm miễn phí →" (browse homepage, no signup)
 *
...
(function() {
  ...
  if (isLoggedIn && isProductDomain) {
    ...
    // sol.vn brand domain → Low-commitment CTA (browse first, no signup gate)
    widgetHtml = `
      <div id="sol-nav-v3">
        <a href="${PRODUCT_URL}/" id="sol-nav-cta" aria-label="Trải nghiệm miễn phí">
          <span>🧭</span>

# 35. Lập Trình Viên Freelance

**Slug**: `lap-trinh-vien-freelance`
**Category**: CHUYEN_MON
**Sort order**: 6
**Status**: ⬜ TODO
**Direction ID**: `81d0c02a-e0d6-4bc1-a118-315a29766501`
...
6. Copy JSON output → save thành `roadmap-lap-trinh-vien-freelance.json` trong folder `generated/`
...
**Tên**: Lập Trình Viên Freelance
**Slug**: lap-trinh-vien-freelance
**Tagline**: Phát triển phần mềm, website theo dự án
**Category**: CHUYEN_MON

**Description**:
Nhận dự án phát triển phần mềm, ứng dụng, website từ khách hàng trong và ngoài nước.

**Vì sao phù hợp 40-60**:
Lý tưởng cho kỹ sư phần mềm muốn làm việc tự do, có thể khai thác thị trường quốc tế.

**Rào cản đặc thù**:
[
  "Cần kỹ năng tự quản lý",
  "Cạnh tranh toàn cầu"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 25
- Expert (chuyên môn sâu): 90
- Builder (thích tự xây): 75
...
- Network (quan hệ): 40
- Risk (rủi ro): 15
- Energy (năng lượng): 55

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 75
- Income potential (tiềm năng thu nhập): 75
- Scalability (khả năng scale): 45
- AI leverage (leverage được AI): 85
...
1. `version`: "1.0"
2. `direction_id`: "81d0c02a-e0d6-4bc1-a118-315a29766501"
3. `direction_name`: "Lập Trình Viên Freelance"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Lập Trình Viên Freelance**
...
- **Considering DNA scores cho mô hình này**:
  ...
  - vp_expert 90/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 10/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 90/100 → phase 1 phải học tech tools

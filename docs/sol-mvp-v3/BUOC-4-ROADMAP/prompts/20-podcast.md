...
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `3867c63a-202f-4e44-9136-a214d0487b8f`
...
6. Copy JSON output → save thành `roadmap-podcast.json` trong folder `generated/`
...
**Description**:
Sản xuất podcast chuyên đề để xây dựng audience và brand.

**Vì sao phù hợp 40-60**:
Phù hợp người thích trò chuyện, có mạng lưới guest tốt.

**Rào cản đặc thù**:
[
  "Thị trường podcast VN còn nhỏ",
  "Monetize khó hơn YouTube"
]
...
1. `version`: "1.0"
2. `direction_id`: "3867c63a-202f-4e44-9136-a214d0487b8f"
3. `direction_name`: "Podcast"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Podcast**
...
- **Considering resources**:
  ...
  - vr_tech 55/100 → tech không phải bottleneck

...
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `e9a04dc2-4412-44f0-a3fd-798f3d422dc9`
...
6. Copy JSON output → save thành `roadmap-dropshipping.json` trong folder `generated/`
...
**Description**:
Bán hàng online không cần kho. Đơn hàng đổ về, nhà cung cấp ship thẳng cho khách.

**Vì sao phù hợp 40-60**:
Phù hợp người muốn kinh doanh với vốn thấp, kỹ năng digital marketing.

**Rào cản đặc thù**:
[
  "Margin thấp",
  "Cạnh tranh cao từ Trung Quốc",
...
1. `version`: "1.0"
2. `direction_id`: "e9a04dc2-4412-44f0-a3fd-798f3d422dc9"
3. `direction_name`: "Dropshipping"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Dropshipping**

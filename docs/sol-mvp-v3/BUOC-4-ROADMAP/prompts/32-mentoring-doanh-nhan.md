# 32. Mentoring Doanh Nhân Trẻ

**Slug**: `mentoring-doanh-nhan`
**Category**: DAO_TAO
**Sort order**: 5
**Status**: ⬜ TODO
**Direction ID**: `16e4b2cc-90a7-4cbb-81b6-7c4e6b8a8f3b`
...
6. Copy JSON output → save thành `roadmap-mentoring-doanh-nhan.json` trong folder `generated/`
...
**Tên**: Mentoring Doanh Nhân Trẻ
**Slug**: mentoring-doanh-nhan
**Tagline**: Hướng dẫn và đồng hành doanh nhân khởi nghiệp
**Category**: DAO_TAO

**Description**:
Mentoring 1:1 cho doanh nhân khởi nghiệp từ kinh nghiệm thực chiến.

**Vì sao phù hợp 40-60**:
Lý tưởng cho cựu CEO/founder muốn truyền kinh nghiệm, ít thời gian nhưng có impact cao.

**Rào cản đặc thù**:
[
  "Khó định giá",
  "Cần danh tiếng trước"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 85
- Expert (chuyên môn sâu): 80
- Builder (thích tự xây): 50
...
- Network (quan hệ): 80
- Risk (rủi ro): 15
- Energy (năng lượng): 50

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 40
- Income potential (tiềm năng thu nhập): 60
...
1. `version`: "1.0"
2. `direction_id`: "16e4b2cc-90a7-4cbb-81b6-7c4e6b8a8f3b"
3. `direction_name`: "Mentoring Doanh Nhân Trẻ"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Mentoring Doanh Nhân Trẻ**
...
- **Considering DNA scores cho mô hình này**:
  ...
  - vp_expert 80/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 10/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 30/100 → tech không phải bottleneck

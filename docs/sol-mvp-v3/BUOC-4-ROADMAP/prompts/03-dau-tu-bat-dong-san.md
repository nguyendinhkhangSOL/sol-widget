# 03. Đầu Tư Bất Động Sản Cho Thuê

**Slug**: `dau-tu-bat-dong-san`
**Category**: DAU_TU
**Sort order**: 1
**Status**: ⬜ TODO
**Direction ID**: `3d5bb07e-7f7c-458f-9b0f-5e28b6bf3fec`
...
6. Copy JSON output → save thành `roadmap-dau-tu-bat-dong-san.json` trong folder `generated/`
...
**Tên**: Đầu Tư Bất Động Sản Cho Thuê
**Slug**: dau-tu-bat-dong-san
**Tagline**: Mua và cho thuê bất động sản tạo thu nhập thụ động
**Category**: DAU_TU

**Description**:
Đầu tư mua bất động sản cho thuê để tạo dòng tiền thụ động.

**Vì sao phù hợp 40-60**:
Phù hợp người có vốn lớn, muốn thu nhập thụ động ổn định.
...
- Network (quan hệ): 60
- Risk (rủi ro): 55
- Energy (năng lượng): 30

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 25
- Income potential (tiềm năng thu nhập): 85
- Scalability (khả năng scale): 70
...
1. `version`: "1.0"
2. `direction_id`: "3d5bb07e-7f7c-458f-9b0f-5e28b6bf3fec"
3. `direction_name`: "Đầu Tư Bất Động Sản Cho Thuê"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Đầu Tư Bất Động Sản Cho Thuê**
...
- **Considering resources**:
  - vr_capital 90/100 → phase 1 phải có action về capital planning

# 22. Chăm Sóc Sức Khỏe Tại Nhà

**Slug**: `cham-soc-suc-khoe-tai-nha`
**Category**: DAILY
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `b0c35a3a-1933-4756-812b-62f25e3cbc4a`
...
6. Copy JSON output → save thành `roadmap-cham-soc-suc-khoe-tai-nha.json` trong folder `generated/`
...
**Tên**: Chăm Sóc Sức Khỏe Tại Nhà
**Slug**: cham-soc-suc-khoe-tai-nha
**Tagline**: Điều dưỡng, chăm sóc người cao tuổi tại nhà
**Category**: DAILY

**Description**:
Cung cấp dịch vụ chăm sóc sức khỏe, điều dưỡng cho người cao tuổi và bệnh nhân tại nhà.

**Vì sao phù hợp 40-60**:
Phù hợp người có chuyên môn y tế, hoặc kinh nghiệm chăm sóc, giàu empathy.

**Rào cản đặc thù**:
[
  "Trách nhiệm cao",
  "Nhu cầu thể lực và tinh thần tốt"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 85
- Expert (chuyên môn sâu): 70
- Builder (thích tự xây): 30
- Independent (tự chủ): 60
...
- Income potential (tiềm năng thu nhập): 55
...
1. `version`: "1.0"
2. `direction_id`: "b0c35a3a-1933-4756-812b-62f25e3cbc4a"
3. `direction_name`: "Chăm Sóc Sức Khỏe Tại Nhà"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Chăm Sóc Sức Khỏe Tại Nhà**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 85/100 → nhiều outreach actions
  - vp_expert 70/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 15/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 25/100 → tech không phải bottleneck

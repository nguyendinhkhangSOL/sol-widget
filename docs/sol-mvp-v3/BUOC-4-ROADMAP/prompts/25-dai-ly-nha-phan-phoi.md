# 25. Đại Lý / Nhà Phân Phối

**Slug**: `dai-ly-nha-phan-phoi`
**Category**: KINH_DOANH
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `7fcde8d4-dda4-445a-83f6-acb6913a54b0`
...
6. Copy JSON output → save thành `roadmap-dai-ly-nha-phan-phoi.json` trong folder `generated/`
...
**Tên**: Đại Lý / Nhà Phân Phối
**Slug**: dai-ly-nha-phan-phoi
**Tagline**: Làm đại lý phân phối cho thương hiệu có sẵn
**Category**: KINH_DOANH

**Description**:
Làm đại lý cấp 1/2 cho nhãn hàng, phân phối qua mạng lưới bán lẻ.

**Vì sao phù hợp 40-60**:
Phù hợp người có vốn, mạng lưới khách hàng, kinh nghiệm bán hàng B2B.

**Rào cản đặc thù**:
[
  "Vốn ban đầu lớn",
  "Phụ thuộc vào chính sách của nhãn hàng"
]
...
1. `version`: "1.0"
2. `direction_id`: "7fcde8d4-dda4-445a-83f6-acb6913a54b0"
3. `direction_name`: "Đại Lý / Nhà Phân Phối"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Đại Lý / Nhà Phân Phối**
...
- **Considering resources**:
  - vr_capital 60/100 → phase 1 phải có action về capital planning

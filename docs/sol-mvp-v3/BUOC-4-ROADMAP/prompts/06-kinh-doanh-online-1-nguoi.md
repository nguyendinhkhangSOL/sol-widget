# 06. Kinh Doanh Online 1 Người

**Slug**: `kinh-doanh-online-1-nguoi`
**Category**: KINH_DOANH
**Sort order**: 1
**Status**: ⬜ TODO
**Direction ID**: `29d5f425-d3d0-4060-ba5f-10bc211e38f1`
...
6. Copy JSON output → save thành `roadmap-kinh-doanh-online-1-nguoi.json` trong folder `generated/`
...
**Tên**: Kinh Doanh Online 1 Người
**Slug**: kinh-doanh-online-1-nguoi
**Tagline**: Bán hàng online qua mạng xã hội và sàn TMĐT
**Category**: KINH_DOANH

**Description**:
Kinh doanh sản phẩm qua Facebook, TikTok, Shopee, Lazada.

**Vì sao phù hợp 40-60**:
Phù hợp người năng động, thích kinh doanh nhưng không muốn cửa hàng cố định.
...
- AI leverage (leverage được AI): 60
...
1. `version`: "1.0"
2. `direction_id`: "29d5f425-d3d0-4060-ba5f-10bc211e38f1"
3. `direction_name`: "Kinh Doanh Online 1 Người"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Kinh Doanh Online 1 Người**
...
- **Considering resources**:
  - vr_capital 45/100 → capital thấp, focus effort thay vì vốn

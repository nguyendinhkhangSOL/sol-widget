# 21. Chuyên Gia Đào Tạo Nội Bộ

**Slug**: `chuyen-gia-dao-tao-noi-bo`
**Category**: CHUYEN_MON
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `74c570e3-ce62-4b84-9334-2c362cec4315`
...
6. Copy JSON output → save thành `roadmap-chuyen-gia-dao-tao-noi-bo.json` trong folder `generated/`
...
**Tên**: Chuyên Gia Đào Tạo Nội Bộ
**Slug**: chuyen-gia-dao-tao-noi-bo
**Tagline**: Đào tạo kỹ năng cho đội ngũ doanh nghiệp
**Category**: CHUYEN_MON

**Description**:
Thiết kế và thực hiện chương trình đào tạo kỹ năng cho doanh nghiệp.

**Vì sao phù hợp 40-60**:
Phù hợp người vừa có chuyên môn vừa có khả năng truyền đạt, thích làm việc với người.

**Rào cản đặc thù**:
[
  "Cần danh tiếng",
  "Phụ thuộc vào ngân sách training của DN"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 75
- Expert (chuyên môn sâu): 85
- Builder (thích tự xây): 40
- Independent (tự chủ): 65
...
1. `version`: "1.0"
2. `direction_id`: "74c570e3-ce62-4b84-9334-2c362cec4315"
3. `direction_name`: "Chuyên Gia Đào Tạo Nội Bộ"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Chuyên Gia Đào Tạo Nội Bộ**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 75/100 → nhiều outreach actions

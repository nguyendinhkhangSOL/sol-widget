# 01. Blog / Website Chuyên Môn

**Slug**: `blog-chuyen-mon`
**Category**: NOI_DUNG_SO
**Sort order**: 1
**Status**: ⬜ TODO
**Direction ID**: `b00226b1-9276-4282-84a9-60e58a666acc`
...
6. Copy JSON output → save thành `roadmap-blog-chuyen-mon.json` trong folder `generated/`
...
**Tên**: Blog / Website Chuyên Môn
**Slug**: blog-chuyen-mon
**Tagline**: Viết blog chia sẻ kiến thức chuyên ngành
**Category**: NOI_DUNG_SO

**Description**:
Xây dựng blog chuyên môn để thu hút traffic, monetize qua affiliate, ads, khóa học.

**Vì sao phù hợp 40-60**:
Phù hợp người thích viết, có kiến thức chuyên sâu, kiên nhẫn dài hạn.

**Rào cản đặc thù**:
[
  "Mất 6-12 tháng mới có traffic đáng kể",
  "Cần nhất quán"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 30
- Expert (chuyên môn sâu): 85
- Builder (thích tự xây): 65
...
**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 15
- Income potential (tiềm năng thu nhập): 75
- Scalability (khả năng scale): 85
...
1. `version`: "1.0"
2. `direction_id`: "b00226b1-9276-4282-84a9-60e58a666acc"
3. `direction_name`: "Blog / Website Chuyên Môn"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Blog / Website Chuyên Môn**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 30/100 → ít outreach actions

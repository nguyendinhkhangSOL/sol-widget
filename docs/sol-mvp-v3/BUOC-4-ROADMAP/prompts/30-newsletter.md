# 30. Newsletter / Substack

**Slug**: `newsletter`
**Category**: NOI_DUNG_SO
**Sort order**: 5
**Status**: ⬜ TODO
**Direction ID**: `555b6b63-e9c1-4f88-814f-bd8f7bd96b1a`
...
6. Copy JSON output → save thành `roadmap-newsletter.json` trong folder `generated/`
...
**Tên**: Newsletter / Substack
**Slug**: newsletter
**Tagline**: Newsletter chuyên đề có trả phí
**Category**: NOI_DUNG_SO

**Description**:
Viết newsletter định kỳ có trả phí về chủ đề chuyên môn.

**Vì sao phù hợp 40-60**:
Phù hợp người viết tốt, có góc nhìn độc đáo, audience tiếng Anh hoặc chuyên ngành.

**Rào cản đặc thù**:
[
  "Substack VN chưa phổ biến",
  "Cần audience sẵn có"
]
...
1. `version`: "1.0"
2. `direction_id`: "555b6b63-e9c1-4f88-814f-bd8f7bd96b1a"
3. `direction_name`: "Newsletter / Substack"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Newsletter / Substack**

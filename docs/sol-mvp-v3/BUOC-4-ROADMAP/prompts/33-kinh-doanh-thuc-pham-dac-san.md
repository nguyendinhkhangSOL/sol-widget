# 33. Kinh Doanh Thực Phẩm Đặc Sản

**Slug**: `kinh-doanh-thuc-pham-dac-san`
**Category**: KINH_DOANH
**Sort order**: 6
**Status**: ⬜ TODO
**Direction ID**: `59b2c318-e7f0-49b8-bea0-abf6ba050166`
...
6. Copy JSON output → save thành `roadmap-kinh-doanh-thuc-pham-dac-san.json` trong folder `generated/`
...
**Tên**: Kinh Doanh Thực Phẩm Đặc Sản
**Slug**: kinh-doanh-thuc-pham-dac-san
**Tagline**: Bán đặc sản vùng miền qua mạng
**Category**: KINH_DOANH

**Description**:
Tìm nguồn và bán đặc sản địa phương, thực phẩm sạch qua online.

**Vì sao phù hợp 40-60**:
Phù hợp người có mối quan hệ địa phương, hiểu văn hóa vùng miền.

**Rào cản đặc thù**:
[
  "An toàn thực phẩm",
  "Logistics cho hàng tươi sống"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 60
- Expert (chuyên môn sâu): 45
...
1. `version`: "1.0"
2. `direction_id`: "59b2c318-e7f0-49b8-bea0-abf6ba050166"
3. `direction_name`: "Kinh Doanh Thực Phẩm Đặc Sản"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Kinh Doanh Thực Phẩm Đặc Sản**
...
- **Considering DNA scores cho mô hình này**:
  ...
  - vp_expert 45/100 → ít content/thought leadership actions
- **Considering resources**:
  - vr_capital 35/100 → capital thấp, focus effort thay vì vốn

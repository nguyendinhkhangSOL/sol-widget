# 23. Dịch Vụ Kế Toán / Thuế Cho SME

**Slug**: `ke-toan-thue-sme`
**Category**: DICH_VU
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `82e6d662-87c9-4e21-8291-1adfa037a9f4`
...
6. Copy JSON output → save thành `roadmap-ke-toan-thue-sme.json` trong folder `generated/`
...
**Tên**: Dịch Vụ Kế Toán / Thuế Cho SME
**Slug**: ke-toan-thue-sme
**Tagline**: Kế toán thuế outsource cho doanh nghiệp nhỏ
**Category**: DICH_VU

**Description**:
Cung cấp dịch vụ kế toán, quyết toán thuế thuê ngoài cho SME.

**Vì sao phù hợp 40-60**:
Phù hợp kế toán viên muốn làm độc lập, phục vụ nhiều doanh nghiệp nhỏ.

**Rào cản đặc thù**:
[
  "Cần chứng chỉ kế toán",
  "Trách nhiệm pháp lý"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 40
- Expert (chuyên môn sâu): 90
- Builder (thích tự xây): 35
...
1. `version`: "1.0"
2. `direction_id`: "82e6d662-87c9-4e21-8291-1adfa037a9f4"
3. `direction_name`: "Dịch Vụ Kế Toán / Thuế Cho SME"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Dịch Vụ Kế Toán / Thuế Cho SME**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 40/100 → ít outreach actions

# 02. Freelancer Chuyên Môn

**Slug**: `freelancer-chuyen-mon`
**Category**: CHUYEN_MON
**Sort order**: 1
**Status**: ✅ DONE (đã có sample)
**Direction ID**: `214e7b23-a38a-4d6a-8c81-91bd3297d1a8`
...
6. Copy JSON output → save thành `roadmap-freelancer-chuyen-mon.json` trong folder `generated/`
...
**Tên**: Freelancer Chuyên Môn
**Slug**: freelancer-chuyen-mon
**Tagline**: Bán kỹ năng chuyên môn theo dự án
**Category**: CHUYEN_MON

**Description**:
Cung cấp dịch vụ chuyên môn theo dự án cho khách hàng doanh nghiệp hoặc cá nhân.

**Vì sao phù hợp 40-60**:
Phù hợp nhất với người có kiến thức chuyên sâu, muốn làm việc độc lập và kiếm tiền từ kỹ năng tích lũy nhiều năm.

**Rào cản đặc thù**:
[
  "Cạnh tranh cao",
  "Cần portfolio",
  "Thu nhập không đều ban đầu"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 35
- Expert (chuyên môn sâu): 95
- Builder (thích tự xây): 40
- Independent (tự chủ): 85
...
- Network (quan hệ): 50
- Risk (rủi ro): 15
- Energy (năng lượng): 40

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 70
- Income potential (tiềm năng thu nhập): 65
- Scalability (khả năng scale): 35
- AI leverage (leverage được AI): 70
...
1. `version`: "1.0"
2. `direction_id`: "214e7b23-a38a-4d6a-8c81-91bd3297d1a8"
3. `direction_name`: "Freelancer Chuyên Môn"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Freelancer Chuyên Môn**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 35/100 → ít outreach actions
  - vp_expert 95/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 10/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 45/100 → tech không phải bottleneck

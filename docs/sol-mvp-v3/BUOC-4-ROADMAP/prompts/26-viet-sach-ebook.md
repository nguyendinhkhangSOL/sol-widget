...
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `38da9e31-9b69-48dc-beee-40e7b281af1f`
...
6. Copy JSON output → save thành `roadmap-viet-sach-ebook.json` trong folder `generated/`
...
**Description**:
Viết và tự xuất bản sách hoặc ebook về chủ đề chuyên môn.

**Vì sao phù hợp 40-60**:
Phù hợp người có kiến thức sâu, thích viết, muốn để lại di sản.

**Rào cản đặc thù**:
[
  "Thu nhập thấp nếu không có audience sẵn",
  "Cần marketing"
]
...
1. `version`: "1.0"
2. `direction_id`: "38da9e31-9b69-48dc-beee-40e7b281af1f"
3. `direction_name`: "Viết Sách / Ebook"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Viết Sách / Ebook**

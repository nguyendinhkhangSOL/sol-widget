# 14. Sửa Chữa Nhà / Điện Nước

**Slug**: `sua-chua-nha`
**Category**: DAILY
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `3bbaba3c-2038-4c36-a326-490eefc742aa`
...
6. Copy JSON output → save thành `roadmap-sua-chua-nha.json` trong folder `generated/`
...
**Tên**: Sửa Chữa Nhà / Điện Nước
**Slug**: sua-chua-nha
**Tagline**: Dịch vụ sửa chữa nhà, điện nước, nội thất
**Category**: DAILY

**Description**:
Nhận sửa chữa nhà cửa, điện nước, nội thất cho hộ gia đình.

**Vì sao phù hợp 40-60**:
Phù hợp người có tay nghề kỹ thuật, muốn làm chủ thời gian.

**Rào cản đặc thù**:
[
  "Nặng nhọc",
  "Khó tìm thợ phụ đáng tin"
]
...
**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 80
...
1. `version`: "1.0"
2. `direction_id`: "3bbaba3c-2038-4c36-a326-490eefc742aa"
3. `direction_name`: "Sửa Chữa Nhà / Điện Nước"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Sửa Chữa Nhà / Điện Nước**

...
**Sort order**: 5
**Status**: ⬜ TODO
**Direction ID**: `a5595f48-cd19-4e71-9583-b827e8a03375`
...
6. Copy JSON output → save thành `roadmap-dich-vu-thu-cung.json` trong folder `generated/`
...
**Tên**: Dịch Vụ Thú Cưng
**Slug**: dich-vu-thu-cung
**Tagline**: Trông giữ, tắm grooming, huấn luyện thú cưng
**Category**: DAILY

**Description**:
Cung cấp dịch vụ chăm sóc thú cưng: trông giữ, tắm, cắt tỉa, huấn luyện.

**Vì sao phù hợp 40-60**:
Phù hợp người yêu thú cưng, có không gian nhà phù hợp.

**Rào cản đặc thù**:
[
  "Trách nhiệm với thú cưng người khác",
  "Cần không gian"
]
...
1. `version`: "1.0"
2. `direction_id`: "a5595f48-cd19-4e71-9583-b827e8a03375"
3. `direction_name`: "Dịch Vụ Thú Cưng"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Dịch Vụ Thú Cưng**

# 24. Luật Sư / Kế Toán Độc Lập

**Slug**: `luat-su-ke-toan-doc-lap`
**Category**: CHUYEN_MON
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `fb0ed8b3-0905-4fdb-8256-686a1fdd2e51`
...
6. Copy JSON output → save thành `roadmap-luat-su-ke-toan-doc-lap.json` trong folder `generated/`
...
**Tên**: Luật Sư / Kế Toán Độc Lập
**Slug**: luat-su-ke-toan-doc-lap
**Tagline**: Dịch vụ pháp lý và tài chính cho SMEs
**Category**: CHUYEN_MON

**Description**:
Cung cấp dịch vụ pháp lý hoặc kế toán cho cá nhân và doanh nghiệp nhỏ.

**Vì sao phù hợp 40-60**:
Yêu cầu bằng cấp chuyên ngành, phù hợp người đã có hành nghề và muốn độc lập.
...
1. `version`: "1.0"
2. `direction_id`: "fb0ed8b3-0905-4fdb-8256-686a1fdd2e51"
3. `direction_name`: "Luật Sư / Kế Toán Độc Lập"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Luật Sư / Kế Toán Độc Lập**

# 17. Đầu Tư Tài Chính (Cổ Phiếu / Quỹ ETF)

**Slug**: `dau-tu-tai-chinh`
**Category**: DAU_TU
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `95566bd5-3875-4fbe-b2e7-96896438cedd`
...
6. Copy JSON output → save thành `roadmap-dau-tu-tai-chinh.json` trong folder `generated/`
...
**Tên**: Đầu Tư Tài Chính (Cổ Phiếu / Quỹ ETF)
**Slug**: dau-tu-tai-chinh
**Tagline**: Đầu tư dài hạn qua cổ phiếu và quỹ ETF
**Category**: DAU_TU

**Description**:
Đầu tư dài hạn vào cổ phiếu, quỹ ETF để tăng trưởng tài sản.

**Vì sao phù hợp 40-60**:
Phù hợp người có vốn nhàn rỗi, kỷ luật tài chính, tầm nhìn dài hạn.

**Rào cản đặc thù**:
[
  "Rủi ro thị trường",
  "Cần kiến thức tài chính",
  "Thu nhập không đều"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 20
- Expert (chuyên môn sâu): 60
...
- Network (quan hệ): 30
- Risk (rủi ro): 65
- Energy (năng lượng): 20

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 10
- Income potential (tiềm năng thu nhập): 80
- Scalability (khả năng scale): 90
- AI leverage (leverage được AI): 55
...
1. `version`: "1.0"
2. `direction_id`: "95566bd5-3875-4fbe-b2e7-96896438cedd"
3. `direction_name`: "Đầu Tư Tài Chính (Cổ Phiếu / Quỹ ETF)"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Đầu Tư Tài Chính (Cổ Phiếu / Quỹ ETF)**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 20/100 → ít outreach actions
  - vp_expert 60/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 75/100 → phase 1 phải có action về capital planning

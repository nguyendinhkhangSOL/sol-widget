# 12. Tư Vấn Doanh Nghiệp

**Slug**: `tu-van-doanh-nghiep`
**Category**: CHUYEN_MON
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `95ea5eb1-8ef3-438a-8b05-48c3225ac31a`
...
6. Copy JSON output → save thành `roadmap-tu-van-doanh-nghiep.json` trong folder `generated/`
...
**Tên**: Tư Vấn Doanh Nghiệp
**Slug**: tu-van-doanh-nghiep
**Tagline**: Cố vấn chiến lược cho doanh nghiệp vừa và nhỏ
**Category**: CHUYEN_MON

**Description**:
Cung cấp dịch vụ tư vấn chiến lược, vận hành, tài chính cho SMEs.

**Vì sao phù hợp 40-60**:
Lý tưởng cho người có 15+ năm kinh nghiệm quản lý, mạng lưới quan hệ rộng.

**Rào cản đặc thù**:
[
  "Cần credibility mạnh",
  "Chu kỳ bán hàng dài",
  "Cạnh tranh với công ty tư vấn lớn"
]
...
1. `version`: "1.0"
2. `direction_id`: "95ea5eb1-8ef3-438a-8b05-48c3225ac31a"
3. `direction_name`: "Tư Vấn Doanh Nghiệp"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Tư Vấn Doanh Nghiệp**

...
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `516b95ea-4faa-4956-b85d-d8da815c5659`
...
6. Copy JSON output → save thành `roadmap-to-chuc-su-kien.json` trong folder `generated/`
...
**Description**:
Lên kế hoạch, điều phối và thực hiện sự kiện: hội nghị, tiệc cưới, team building.

**Vì sao phù hợp 40-60**:
Phù hợp người có khả năng tổ chức, network rộng với vendor.

**Rào cản đặc thù**:
[
  "Áp lực ngày sự kiện cao",
  "Rủi ro do nhà cung cấp"
]
...
1. `version`: "1.0"
2. `direction_id`: "516b95ea-4faa-4956-b85d-d8da815c5659"
3. `direction_name`: "Tổ Chức Sự Kiện"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Tổ Chức Sự Kiện**

# 07. Life Coaching / Career Coaching

**Slug**: `life-coaching`
**Category**: DAO_TAO
**Sort order**: 1
**Status**: ⬜ TODO
**Direction ID**: `d20deff9-1d19-4d70-84b9-6f6d489a010f`
...
6. Copy JSON output → save thành `roadmap-life-coaching.json` trong folder `generated/`
...
**Tên**: Life Coaching / Career Coaching
**Slug**: life-coaching
**Tagline**: Hỗ trợ cá nhân phát triển bản thân và sự nghiệp
**Category**: DAO_TAO

**Description**:
Coaching 1:1 hoặc nhóm giúp khách hàng đạt mục tiêu cá nhân, nghề nghiệp.

**Vì sao phù hợp 40-60**:
Phù hợp người có khả năng lắng nghe, empathy cao, kinh nghiệm sống phong phú.

**Rào cản đặc thù**:
[
  "Cần chứng chỉ ICF để tăng credibility",
  "Khó định giá ban đầu"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 90
- Expert (chuyên môn sâu): 70
- Builder (thích tự xây): 45
- Independent (tự chủ): 75
...
1. `version`: "1.0"
2. `direction_id`: "d20deff9-1d19-4d70-84b9-6f6d489a010f"
3. `direction_name`: "Life Coaching / Career Coaching"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Life Coaching / Career Coaching**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 90/100 → nhiều outreach actions

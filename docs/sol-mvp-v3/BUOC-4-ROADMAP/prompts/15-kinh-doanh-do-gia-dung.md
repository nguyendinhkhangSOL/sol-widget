# 15. Kinh Doanh Đồ Gia Dụng / Nội Thất

**Slug**: `kinh-doanh-do-gia-dung`
**Category**: KINH_DOANH
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `4e6cd964-4cb7-4598-bc70-e814a8c6fa35`
...
6. Copy JSON output → save thành `roadmap-kinh-doanh-do-gia-dung.json` trong folder `generated/`
...
**Tên**: Kinh Doanh Đồ Gia Dụng / Nội Thất
**Slug**: kinh-doanh-do-gia-dung
**Tagline**: Nhập và phân phối đồ gia dụng, nội thất
**Category**: KINH_DOANH

**Description**:
Nhập hàng gia dụng, nội thất từ nhà sản xuất, bán qua online và offline.

**Vì sao phù hợp 40-60**:
Phù hợp người có vốn, mạng lưới nhà cung cấp, hiểu thị trường địa phương.

**Rào cản đặc thù**:
[
  "Cần vốn hàng tồn cao",
  "Logistics cồng kềnh"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 55
- Expert (chuyên môn sâu): 40
...
**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 55
- Income potential (tiềm năng thu nhập): 70
- Scalability (khả năng scale): 55
- AI leverage (leverage được AI): 45
...
1. `version`: "1.0"
2. `direction_id`: "4e6cd964-4cb7-4598-bc70-e814a8c6fa35"
3. `direction_name`: "Kinh Doanh Đồ Gia Dụng / Nội Thất"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Kinh Doanh Đồ Gia Dụng / Nội Thất**
...
- **Considering DNA scores cho mô hình này**:
  ...
  - vp_expert 40/100 → ít content/thought leadership actions
- **Considering resources**:
  - vr_capital 65/100 → phase 1 phải có action về capital planning

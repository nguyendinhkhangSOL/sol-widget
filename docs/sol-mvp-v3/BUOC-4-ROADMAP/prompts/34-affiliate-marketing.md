...
**Sort order**: 6
**Status**: ⬜ TODO
**Direction ID**: `39011b9a-4893-4db8-89cd-b5db62ed6d22`
...
6. Copy JSON output → save thành `roadmap-affiliate-marketing.json` trong folder `generated/`
...
**Tên**: Affiliate Marketing
**Slug**: affiliate-marketing
**Tagline**: Kiếm hoa hồng từ giới thiệu sản phẩm
**Category**: NOI_DUNG_SO

**Description**:
Xây kênh content để giới thiệu sản phẩm/dịch vụ và nhận hoa hồng.

**Vì sao phù hợp 40-60**:
Phù hợp người thích content, muốn thu nhập thụ động.

**Rào cản đặc thù**:
[
  "Cần traffic lớn để có thu nhập đáng kể",
  "Thuật toán platform thay đổi liên tục"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 45
- Expert (chuyên môn sâu): 55
...
**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 20
...
1. `version`: "1.0"
2. `direction_id`: "39011b9a-4893-4db8-89cd-b5db62ed6d22"
3. `direction_name`: "Affiliate Marketing"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Affiliate Marketing**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 45/100 → ít outreach actions
  - vp_expert 55/100 → ít content/thought leadership actions
- **Considering resources**:
  - vr_capital 20/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 60/100 → phase 1 phải học tech tools

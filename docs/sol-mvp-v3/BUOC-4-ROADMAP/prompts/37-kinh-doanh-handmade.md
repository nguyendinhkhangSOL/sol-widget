# 37. Kinh Doanh Handmade / Thủ Công

**Slug**: `kinh-doanh-handmade`
**Category**: KINH_DOANH
**Sort order**: 7
**Status**: ⬜ TODO
**Direction ID**: `8df5dee6-fc61-4dd3-be60-02c1c7e7cdf6`
...
6. Copy JSON output → save thành `roadmap-kinh-doanh-handmade.json` trong folder `generated/`
...
**Tên**: Kinh Doanh Handmade / Thủ Công
**Slug**: kinh-doanh-handmade
**Tagline**: Làm và bán sản phẩm thủ công mỹ nghệ
**Category**: KINH_DOANH

**Description**:
Tạo và bán sản phẩm handmade: gốm, đan móc, gỗ, candle, jewelry.

**Vì sao phù hợp 40-60**:
Phù hợp người có kỹ năng thủ công, thích sáng tạo, muốn làm việc tại nhà.

**Rào cản đặc thù**:
[
  "Thời gian tạo sản phẩm lớn",
  "Giá bán bị giới hạn bởi thị trường"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 50
- Expert (chuyên môn sâu): 65
...
1. `version`: "1.0"
2. `direction_id`: "8df5dee6-fc61-4dd3-be60-02c1c7e7cdf6"
3. `direction_name`: "Kinh Doanh Handmade / Thủ Công"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Kinh Doanh Handmade / Thủ Công**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 50/100 → ít outreach actions
  - vp_expert 65/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 25/100 → capital thấp, focus effort thay vì vốn

...
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `d1776b93-3ccd-431b-bf44-e4c483868a81`
...
6. Copy JSON output → save thành `roadmap-youtube-channel.json` trong folder `generated/`
...
**Description**:
Tạo nội dung video trên YouTube để chia sẻ kiến thức và xây dựng thu nhập.

**Vì sao phù hợp 40-60**:
Phù hợp người tự tin trước camera, kiên nhẫn với quá trình dài.

**Rào cản đặc thù**:
[
  "Mất 12-18 tháng để có thu nhập đáng kể",
  "Yêu cầu chất lượng video/âm thanh"
]
...
- Income potential (tiềm năng thu nhập): 85
...
1. `version`: "1.0"
2. `direction_id`: "d1776b93-3ccd-431b-bf44-e4c483868a81"
3. `direction_name`: "YouTube Channel"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **YouTube Channel**

# 36. Dịch Thuật Chuyên Ngành

**Slug**: `dich-thuat-chuyen-nganh`
**Category**: CHUYEN_MON
**Sort order**: 7
**Status**: ⬜ TODO
**Direction ID**: `e6c732c2-17b8-4653-8f15-b34a68a2f565`
...
6. Copy JSON output → save thành `roadmap-dich-thuat-chuyen-nganh.json` trong folder `generated/`
...
**Tên**: Dịch Thuật Chuyên Ngành
**Slug**: dich-thuat-chuyen-nganh
**Tagline**: Dịch thuật tài liệu kỹ thuật, pháp lý, y tế
**Category**: CHUYEN_MON

**Description**:
Dịch tài liệu chuyên ngành (kỹ thuật, y tế, pháp lý, kinh doanh) Anh-Việt và ngược lại.

**Vì sao phù hợp 40-60**:
Phù hợp người thành thạo ngoại ngữ và có chuyên môn ngành.

**Rào cản đặc thù**:
[
  "AI dịch ngày càng tốt",
  "Giá thấp nếu không có niche rõ ràng"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 25
- Expert (chuyên môn sâu): 85
- Builder (thích tự xây): 30
- Independent (tự chủ): 90
...
- Network (quan hệ): 40
- Risk (rủi ro): 10
- Energy (năng lượng): 35

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 60
- Income potential (tiềm năng thu nhập): 50
- Scalability (khả năng scale): 30
- AI leverage (leverage được AI): 65
...
1. `version`: "1.0"
2. `direction_id`: "e6c732c2-17b8-4653-8f15-b34a68a2f565"
3. `direction_name`: "Dịch Thuật Chuyên Ngành"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Dịch Thuật Chuyên Ngành**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 25/100 → ít outreach actions
  - vp_expert 85/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 5/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 50/100 → tech không phải bottleneck

# 04. Chụp Ảnh / Quay Video Sự Kiện

**Slug**: `chup-anh-quay-video`
**Category**: DICH_VU
**Sort order**: 1
**Status**: ⬜ TODO
**Direction ID**: `01050f47-3462-4092-80af-16416a99482c`
...
6. Copy JSON output → save thành `roadmap-chup-anh-quay-video.json` trong folder `generated/`
...
**Tên**: Chụp Ảnh / Quay Video Sự Kiện
**Slug**: chup-anh-quay-video
**Tagline**: Chụp ảnh sự kiện, cưới hỏi, thương mại
**Category**: DICH_VU

**Description**:
Cung cấp dịch vụ chụp ảnh và quay video cho sự kiện, doanh nghiệp.

**Vì sao phù hợp 40-60**:
Phù hợp người có thiết bị tốt, kỹ năng nhiếp ảnh, thích làm việc event.

**Rào cản đặc thù**:
[
  "Thiết bị đắt",
  "Mùa vụ không đều",
  "Hậu kỳ tốn thời gian"
]
...
1. `version`: "1.0"
2. `direction_id`: "01050f47-3462-4092-80af-16416a99482c"
3. `direction_name`: "Chụp Ảnh / Quay Video Sự Kiện"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Chụp Ảnh / Quay Video Sự Kiện**
...
- **Considering resources**:
  - vr_capital 55/100 → capital thấp, focus effort thay vì vốn
  - vr_tech 70/100 → phase 1 phải học tech tools

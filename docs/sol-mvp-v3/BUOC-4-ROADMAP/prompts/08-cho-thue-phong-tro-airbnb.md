# 08. Cho Thuê Phòng Trọ / Airbnb

**Slug**: `cho-thue-phong-tro-airbnb`
**Category**: DAU_TU
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `44abfac2-faa0-4cf6-a5c5-fdfa5fbce3e2`
...
6. Copy JSON output → save thành `roadmap-cho-thue-phong-tro-airbnb.json` trong folder `generated/`
...
**Tên**: Cho Thuê Phòng Trọ / Airbnb
**Slug**: cho-thue-phong-tro-airbnb
**Tagline**: Tối ưu hóa bất động sản nhàn rỗi để cho thuê
**Category**: DAU_TU

**Description**:
Cho thuê phòng trọ dài hạn hoặc căn hộ ngắn hạn qua Airbnb.

**Vì sao phù hợp 40-60**:
Phù hợp người đã có bất động sản, muốn khai thác hiệu quả hơn.
...
1. `version`: "1.0"
2. `direction_id`: "44abfac2-faa0-4cf6-a5c5-fdfa5fbce3e2"
3. `direction_name`: "Cho Thuê Phòng Trọ / Airbnb"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Cho Thuê Phòng Trọ / Airbnb**

# 27. Workshop Chuyên Đề

**Slug**: `workshop-chuyen-de`
**Category**: DAO_TAO
**Sort order**: 4
**Status**: ⬜ TODO
**Direction ID**: `895fadc7-aa47-4930-a89b-a98fa3b257c2`
...
6. Copy JSON output → save thành `roadmap-workshop-chuyen-de.json` trong folder `generated/`
...
**Tên**: Workshop Chuyên Đề
**Slug**: workshop-chuyen-de
**Tagline**: Tổ chức workshop offline/online theo chuyên đề
**Category**: DAO_TAO

**Description**:
Tổ chức workshop 1-2 ngày về chủ đề chuyên môn cho nhóm 10-50 người.

**Vì sao phù hợp 40-60**:
Phù hợp người thích nói trước đám đông, có network để quảng bá.

**Rào cản đặc thù**:
[
  "Rủi ro lấp đầy ghế",
  "Cần logistics và marketing"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 80
- Expert (chuyên môn sâu): 80
- Builder (thích tự xây): 60
...
1. `version`: "1.0"
2. `direction_id`: "895fadc7-aa47-4930-a89b-a98fa3b257c2"
3. `direction_name`: "Workshop Chuyên Đề"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Workshop Chuyên Đề**
...
- **Considering DNA scores cho mô hình này**:
  - vp_people 80/100 → nhiều outreach actions

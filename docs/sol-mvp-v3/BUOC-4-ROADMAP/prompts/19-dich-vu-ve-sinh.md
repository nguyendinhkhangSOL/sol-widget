# 19. Dịch Vụ Vệ Sinh / Dọn Dẹp

**Slug**: `dich-vu-ve-sinh`
**Category**: DAILY
**Sort order**: 3
**Status**: ⬜ TODO
**Direction ID**: `d36e8935-daf7-4ebc-b1b2-1feb88278cf9`
...
6. Copy JSON output → save thành `roadmap-dich-vu-ve-sinh.json` trong folder `generated/`
...
**Tên**: Dịch Vụ Vệ Sinh / Dọn Dẹp
**Slug**: dich-vu-ve-sinh
**Tagline**: Vệ sinh nhà, văn phòng, công trình
**Category**: DAILY

**Description**:
Cung cấp dịch vụ vệ sinh nhà ở, văn phòng, hậu xây dựng.

**Vì sao phù hợp 40-60**:
Entry barrier thấp, thu nhập ngay, có thể mở rộng thành đội.

**Rào cản đặc thù**:
[
  "Tuyển dụng và giữ nhân viên khó",
  "Thị trường phân tán"
]
...
1. `version`: "1.0"
2. `direction_id`: "d36e8935-daf7-4ebc-b1b2-1feb88278cf9"
3. `direction_name`: "Dịch Vụ Vệ Sinh / Dọn Dẹp"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Dịch Vụ Vệ Sinh / Dọn Dẹp**

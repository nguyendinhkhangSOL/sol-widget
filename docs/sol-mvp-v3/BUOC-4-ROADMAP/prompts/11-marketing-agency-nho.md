# 11. Marketing / Social Media Agency Nhỏ

**Slug**: `marketing-agency-nho`
**Category**: DICH_VU
**Sort order**: 2
**Status**: ⬜ TODO
**Direction ID**: `ebf02d2c-3737-4750-9b94-01adc338d156`
...
6. Copy JSON output → save thành `roadmap-marketing-agency-nho.json` trong folder `generated/`
...
**Tên**: Marketing / Social Media Agency Nhỏ
**Slug**: marketing-agency-nho
**Tagline**: Quản lý mạng xã hội và marketing cho SMEs
**Category**: DICH_VU

**Description**:
Cung cấp dịch vụ marketing tổng thể cho doanh nghiệp nhỏ: social media, content, ads.

**Vì sao phù hợp 40-60**:
Phù hợp người có kinh nghiệm marketing, thích digital, muốn phục vụ nhiều client.

**Rào cản đặc thù**:
[
  "Cần team để scale",
  "Client yêu cầu cao về kết quả"
]

**DNA fit scores (0-100)**:
- People (thích tiếp xúc): 65
- Expert (chuyên môn sâu): 70
- Builder (thích tự xây): 70
- Independent (tự chủ): 70
...
- Network (quan hệ): 65
- Risk (rủi ro): 25
- Energy (năng lượng): 65

**Bonus metrics (0-100)**:
- Income speed (tốc độ có thu nhập): 65
- Income potential (tiềm năng thu nhập): 75
- Scalability (khả năng scale): 65
- AI leverage (leverage được AI): 80
...
1. `version`: "1.0"
2. `direction_id`: "ebf02d2c-3737-4750-9b94-01adc338d156"
3. `direction_name`: "Marketing / Social Media Agency Nhỏ"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Marketing / Social Media Agency Nhỏ**
...
- **Considering DNA scores cho mô hình này**:
  ...
  - vp_expert 70/100 → nhiều content/thought leadership actions
- **Considering resources**:
  - vr_capital 20/100 → capital thấp, focus effort thay vì vốn

# 31. Thiết Kế Độc Lập (Graphic / UX)

**Slug**: `thiet-ke-doc-lap`
**Category**: CHUYEN_MON
**Sort order**: 5
**Status**: ⬜ TODO
**Direction ID**: `a214fcb9-2c8f-4160-97d5-90ece5f2eac3`
...
6. Copy JSON output → save thành `roadmap-thiet-ke-doc-lap.json` trong folder `generated/`
...
**Tên**: Thiết Kế Độc Lập (Graphic / UX)
**Slug**: thiet-ke-doc-lap
**Tagline**: Freelance thiết kế cho doanh nghiệp và startup
**Category**: CHUYEN_MON

**Description**:
Cung cấp dịch vụ thiết kế đồ họa, UI/UX, brand identity cho doanh nghiệp.

**Vì sao phù hợp 40-60**:
Phù hợp người có tư duy sáng tạo, kỹ năng phần mềm thiết kế tốt.

**Rào cản đặc thù**:
[
  "Portfolio là yếu tố quyết định",
  "AI đang thay thế một phần công việc"
]
...
1. `version`: "1.0"
2. `direction_id`: "a214fcb9-2c8f-4160-97d5-90ece5f2eac3"
3. `direction_name`: "Thiết Kế Độc Lập (Graphic / UX)"
4. `total_weeks`: 12
5. `total_actions`: 40-50 (tổng actions trong 12 tuần)
6. `phases`: 3 giai đoạn `[Định vị (T1-4), Momentum (T5-8), Khách #1 (T9-12)]` — MỖI phase có `goal` cụ thể cho mô hình **Thiết Kế Độc Lập (Graphic / UX)**
...
- **Considering resources**:
  ...
  - vr_tech 75/100 → phase 1 phải học tech tools

// frontend/src/components/views/phaseB/types.ts
// Type của payload GET /journey/dashboard — Phase B 88-day shape.
...
export interface DashboardData {
  ...
  qDay: {
    ...
    /** Phase B slip detection: true nếu Phase 3-4 và có log smoking trong 24h vừa qua. */
    recentSlip: boolean;
    /** ID của log slip gần nhất — FE dedupe SlipModal qua localStorage. */
...
/** Shared props mà mọi PhaseX component nhận. */

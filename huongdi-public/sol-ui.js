...
(function() {
  ...
  const NAV_ITEMS = [
    ...
    { key: 'aistudio', href: '/ai-studio/',            label: '🎨 AI Studio' },
    { key: 'articles', href: 'https://sol.vn/huong-di/', label: 'Bài viết' },
  ];
  // Note: "Kiểm tra 3 phút" đã bỏ khỏi menu chính (2026-07-06)
  //       Truy cập qua footer "Tài nguyên" hoặc CTA hero homepage.
  ...
  <div class="hd-container">
    <div class="hd-footer__grid">
      ...
      <div class="hd-footer__col">
        <h4>Tài nguyên</h4>
        <ul>
          <li><a href="https://sol.vn/kham-pha-nhanh/" rel="noopener">🎯 Kiểm tra 3 phút <span style="padding:1px 6px;background:#FEF3C7;color:#B45309;border-radius:4px;font-size:10px;font-weight:700;margin-left:4px;">QUIZ</span></a></li>
  ...
  function init() {
    ...
    // ⭐ Skip khi được embed trong iframe (VD: AI Studio tabs)
